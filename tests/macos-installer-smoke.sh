...
for file in install-macos.sh aru-selfhostctl-macos package-macos-release.sh run-node.sh; do
...
bash "$SELFHOST_DIR/package-macos-release.sh" "$artifacts/aru-selfhost-macos.tar.gz" >/dev/null
