...
install -m 0644 "$SOURCE_DIR/claude-code-driver.mjs" "$release_dir/claude-code-driver.mjs"
install -m 0644 "$SOURCE_DIR/claude-code-host-bridge.mjs" "$release_dir/claude-code-host-bridge.mjs"
install -m 0644 "$SOURCE_DIR/claude-code-mcp-bridge.mjs" "$release_dir/claude-code-mcp-bridge.mjs"
