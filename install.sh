...
install -m 0644 "$SOURCE_DIR/collaborator-initiative.mjs" "$release_dir/collaborator-initiative.mjs"
install -m 0644 "$SOURCE_DIR/collaborator-projects.mjs" "$release_dir/collaborator-projects.mjs"
install -m 0644 "$SOURCE_DIR/apns-push.mjs" "$release_dir/apns-push.mjs"
