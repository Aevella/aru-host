...
install -m 0644 "$SOURCE_DIR/conversation-turn-relay-protocol.mjs" "$RELEASES_DIR/$release_id/conversation-turn-relay-protocol.mjs"
install -m 0644 "$SOURCE_DIR/conversation-turn-relay-results.mjs" "$RELEASES_DIR/$release_id/conversation-turn-relay-results.mjs"
