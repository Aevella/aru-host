...
fetch_source_payload() {
  ...
  for file in aru-selfhost-stub.mjs backup-settings.mjs conversation-turn-relay.mjs collaborator-host.mjs mobile-collaborator-replicas.mjs mobile-collaborator-identities.mjs container-runtime-setup.mjs collaborator-cognition.mjs collaborator-surfaces.mjs collaborator-surface-bundles.mjs collaborator-conversations.mjs collaborator-conversation-attachments.mjs collaborator-initiative.mjs collaborator-projects.mjs apns-push.mjs wake-bridge.mjs codex-app-server-driver.mjs claude-code-driver.mjs claude-code-host-bridge.mjs claude-code-mcp-bridge.mjs direct-api-driver.mjs provider-profiles.mjs provider-secret-store.mjs node-control.mjs node-workspaces.mjs plugin-supervisor.mjs plugin-workshop.mjs source-plugin-runtime.mjs source-plugin-runner.mjs run-node.sh install-macos.sh aru-selfhostctl-macos; do
...
install -m 0644 "$SOURCE_DIR/claude-code-driver.mjs" "$RELEASES_DIR/$release_id/claude-code-driver.mjs"
install -m 0644 "$SOURCE_DIR/claude-code-host-bridge.mjs" "$RELEASES_DIR/$release_id/claude-code-host-bridge.mjs"
install -m 0644 "$SOURCE_DIR/claude-code-mcp-bridge.mjs" "$RELEASES_DIR/$release_id/claude-code-mcp-bridge.mjs"
