...
install -m 0644 "$SOURCE_DIR/conversation-turn-relay-protocol.mjs" "$release_dir/conversation-turn-relay-protocol.mjs"
install -m 0644 "$SOURCE_DIR/conversation-turn-relay-results.mjs" "$release_dir/conversation-turn-relay-results.mjs"
...
install -m 0644 "$SOURCE_DIR/collaborator-conversation-attachments.mjs" "$release_dir/collaborator-conversation-attachments.mjs"
...
install -m 0644 "$SOURCE_DIR/wake-bridge.mjs" "$release_dir/wake-bridge.mjs"
...
ARU_WAKE_RELAY_URL="https://wake.aelion.cn"
