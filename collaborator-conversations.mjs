...
return { mutateConversationLifecycle };
})();
...
const { basename, dirname, extname, isAbsolute, join, relative, resolve } = node2;
const { once } = node3;
...
function createCollaboratorConversationHost({
  dataDir,
...
function createCollaboratorConversationAttachmentHost({
  dataDir,
  readJSONBody,
  sendJSON,
  HttpError,
...
return { createCollaboratorConversationHost, createCollaboratorConversationAttachmentHost };
})();

export const { createCollaboratorConversationHost } = module0;
